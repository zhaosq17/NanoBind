...
CUDA_VISIBLE_DEVICES=2 python train_nai.py --Model 0 --finetune 1 --ESM2  esm2_t12_35M_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_nai.py --Model 0 --finetune 1 --ESM2  esm2_t30_150M_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_nai.py --Model 0 --finetune 1 --ESM2  esm2_t33_650M_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_nai.py --Model 0 --finetune 1 --ESM2  esm2_t36_3B_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_nai.py --Model 0 --finetune 1 --ESM2  esm2_t48_15B_UR50D &


2. NanoBind_pro
CUDA_VISIBLE_DEVICES=0 python train_nai.py --Model 1 --finetune 1 --ESM2 esm2_t6_8M_UR50D &

CUDA_VISIBLE_DEVICES=0 python train_nai.py --Model 1 --finetune 1 --ESM2 esm2_t12_35M_UR50D &

CUDA_VISIBLE_DEVICES=0 python train_nai.py --Model 1 --finetune 1 --ESM2 esm2_t30_150M_UR50D &

CUDA_VISIBLE_DEVICES=0 python train_nai.py --Model 1 --finetune 1 --ESM2 esm2_t33_650M_UR50D &

CUDA_VISIBLE_DEVICES=0 python train_nai.py --Model 1 --finetune 1 --ESM2 esm2_t36_3B_UR50D &

CUDA_VISIBLE_DEVICES=0 python train_nai.py --Model 1 --finetune 1 --ESM2 esm2_t48_15B_UR50D &
...
if __name__ == '__main__':
    ...
    if args.Model == 0:
        ...
        if args.ESM2 == 'esm2_t12_35M_UR50D':
            model = NanoBind_seq(pretrained_model=r'./models/esm2_t12_35M_UR50D',hidden_size=480,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t30_150M_UR50D':
            model = NanoBind_seq(pretrained_model=r'./models/esm2_t30_150M_UR50D',hidden_size=640,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t33_650M_UR50D':
            model = NanoBind_seq(pretrained_model=r'./models/esm2_t33_650M_UR50D',hidden_size=1280,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t36_3B_UR50D':
            model = NanoBind_seq(pretrained_model=r'./models/esm2_t36_3B_UR50D',hidden_size=2560,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t48_15B_UR50D':
            model = NanoBind_seq(pretrained_model=r'./models/esm2_t48_15B_UR50D',hidden_size=5120,finetune=args.finetune).to(device)
    elif args.Model == 1:
        if args.ESM2 == 'esm2_t6_8M_UR50D':
        ...
        if args.ESM2 == 'esm2_t12_35M_UR50D':
            model = NanoBind_pro(pretrained_model=r'./models/esm2_t12_35M_UR50D',hidden_size=480,finetune=args.finetune,
                             Model_BSite_path='./output/checkpoint/NanoBind_site(esm2_t12_35M_UR50D)_SabdabData_finetune1_TF0_good.model').to(device)
        if args.ESM2 == 'esm2_t30_150M_UR50D':
            model = NanoBind_pro(pretrained_model=r'./models/esm2_t30_150M_UR50D',hidden_size=640,finetune=args.finetune,
                             Model_BSite_path='./output/checkpoint/NanoBind_site(esm2_t30_150M_UR50D)_SabdabData_finetune1_TF0_good.model').to(device)
        if args.ESM2 == 'esm2_t33_650M_UR50D':
            model = NanoBind_pro(pretrained_model=r'./models/esm2_t33_650M_UR50D',hidden_size=1280,finetune=args.finetune,
                             Model_BSite_path='./output/checkpoint/NanoBind_site(esm2_t33_650M_UR50D)_SabdabData_finetune1_TF0_good.model').to(device)
        if args.ESM2 == 'esm2_t36_3B_UR50D':
            model = NanoBind_pro(pretrained_model=r'./models/esm2_t36_3B_UR50D',hidden_size=2560,finetune=args.finetune,
                             Model_BSite_path='./output/checkpoint/NanoBind_site(esm2_t36_3B_UR50D)_SabdabData_finetune1_TF0_good.model').to(device)
        if args.ESM2 == 'esm2_t48_15B_UR50D':
            model = NanoBind_pro(pretrained_model=r'./models/esm2_t48_15B_UR50D',hidden_size=5120,finetune=args.finetune,
