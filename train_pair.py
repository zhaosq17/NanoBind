...
if __name__ == '__main__':
    ...
    trainDataset = seq_affinity('./data/affinity/train_cross.csv')
    valDataset   = seq_affinity('./data/affinity/val_cross.csv')
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if best_AUC_PR<AUC_PR:
            best_AUC_PR = AUC_PR
            best_epoch = epoch
            torch.save(model.state_dict(), model_file_name +'_cross.model')
