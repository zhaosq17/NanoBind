...
CUDA_VISIBLE_DEVICES=2 python train_site.py --Model 0 --finetune 1 --ESM2  esm2_t12_35M_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_site.py --Model 0 --finetune 1 --ESM2  esm2_t30_150M_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_site.py --Model 0 --finetune 1 --ESM2  esm2_t33_650M_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_site.py --Model 0 --finetune 1 --ESM2  esm2_t36_3B_UR50D &

CUDA_VISIBLE_DEVICES=3 python train_site.py --Model 0 --finetune 1 --ESM2  esm2_t48_15B_UR50D &
'''
...
if __name__ == '__main__':
    ...
    if args.Model == 0:
        ...
        if args.ESM2 == 'esm2_t12_35M_UR50D':
            model = NanoBind_site(pretrained_model=r'./models/esm2_t12_35M_UR50D',hidden_size=480,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t30_150M_UR50D':
            model = NanoBind_site(pretrained_model=r'./models/esm2_t30_150M_UR50D',hidden_size=640,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t33_650M_UR50D':
            model = NanoBind_site(pretrained_model=r'./models/esm2_t33_650M_UR50D',hidden_size=1280,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t36_3B_UR50D':
            model = NanoBind_site(pretrained_model=r'./models/esm2_t36_3B_UR50D',hidden_size=2560,finetune=args.finetune).to(device)
        if args.ESM2 == 'esm2_t48_15B_UR50D':
            model = NanoBind_site(pretrained_model=r'./models/esm2_t48_15B_UR50D',hidden_size=5120,finetune=args.finetune).to(device)
