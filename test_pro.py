...
testDataset  = seqData_NBAT_Test(seq_path='./data/sdab/NAI_test_seq.fasta',pair_path = './data/sdab/NAI_test.tsv')
...
csv_metrics.to_csv(f'./output/test_results/NanoBind_pro_results.csv', index=False)
